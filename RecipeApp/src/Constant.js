...
export const recipeList = [
	{
		...
		color: "#006A4E",
		description:
			"A wonderful holiday ham that will not taste like the holidays, but will bless your home with aromatic flavor",
		steps: [
			"Cut off and set aside excess fat",
			...
			"Turn off oven and remove the ham pan",
			"Cut manageable sized pieces of meat off the bone, then remove bone entirely, and put meat back in the pan",
			"Put pan back into the oven while oven cools. The ham will stay warm for serving",
		],
	},
	{
		id: "02",
